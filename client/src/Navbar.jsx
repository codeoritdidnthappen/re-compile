...
const Navbar = () => {
  ...
  const ThemesSelect = () => {
    const themes = [ "light", "dark", "adcrr", "ndcs", "cupcake", "chill", "bumblebee", "emerald", "corporate", "synthwave", "retro", "cyberpunk", "valentine", "halloween", "garden", "forest", "aqua", "lofi", "pastel", "fantasy", "wireframe", "black", "luxury", "dracula", "cmyk", "autumn", "business", "acid", "lemonade", "night", "coffee", "winter", "dim", "nord", "sunset", "caramellatte", "abyss", "silk", "validmonkey", "mysteryhouse", "garmentcoffee", "icehouse", "demonflip" ]
    return (
      <>
        {themes.map(t => (
            ...
            <div className="dropdown dropdown-bottom dropdown-end">
              ...
              <ul tabIndex={0} className="dropdown-content bg-base-100 rounded-box z-1 w-56 p-2 shadow-sm top-x h-[30.5rem] max-h-[calc(100vh-8.6rem)] overflow-y-auto">
                ...
                <li>
                    ...
                    <Link to="https://daisyui.com/theme-generator/"><div className="grow text-sm font-bold">Make your theme!</div></Link>
                </li>
              </ul>
            </div>
          </li>
