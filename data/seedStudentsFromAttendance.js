...
import attendanceModel from "../server/attendance/attendanceModel.js"
import studentModel from "../server/students/studentModel.js"
...
const main = async () => {
  ...
  const existingDocIds = new Set(
    (await studentModel.find({}, { docId: 1 })).map((s) => s.docId)
  )
